...
*/
-- CreateEnum
CREATE TYPE "PermissionsTypes" AS ENUM ('Read_tables', 'Change_tables', 'Add_tables', 'Delete_tables', 'Add_users', 'Remove_users', 'Edit_userRole');

-- AlterTable
ALTER TABLE "Permissions" DROP COLUMN "name",
ADD COLUMN     "name" "PermissionsTypes" NOT NULL;
